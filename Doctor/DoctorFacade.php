    ...
    <div class="login-box">
        <div class="container">
            ...
            <form action="?" method="POST">
                <div class="user-box1">
                    <input type="email" placeholder="Type Email" name="uemail" required style="font-size:16pt;">
                    <br>
                    <br>
                    <input type="password" placeholder="Type Password" name="upassword" required style="font-size:16pt;">
                </div>
